...
-- Clear existing data
-- ============================================================================
TRUNCATE TABLE IF EXISTS CLIENT_CAMPAIGN_INTERACTIONS;
...
TRUNCATE TABLE IF EXISTS SERVICE_SUBSCRIPTIONS;
TRUNCATE TABLE IF EXISTS FLOOD_CERTIFICATIONS;
TRUNCATE TABLE IF EXISTS TAX_RECORDS;
TRUNCATE TABLE IF EXISTS LOANS;
TRUNCATE TABLE IF EXISTS PROPERTIES;
TRUNCATE TABLE IF EXISTS CLIENTS;
TRUNCATE TABLE IF EXISTS TAX_JURISDICTIONS;
TRUNCATE TABLE IF EXISTS FLOOD_ZONES;
TRUNCATE TABLE IF EXISTS PRODUCTS;
TRUNCATE TABLE IF EXISTS SUPPORT_AGENTS;
